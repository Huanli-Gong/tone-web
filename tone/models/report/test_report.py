...
class ReportTemplate(BaseModel):
    ...
    background_desc = models.TextField(null=True, blank=True, help_text='测试背景描述')
    need_test_method = models.BooleanField(default=False, help_text='是否需要测试方法')
    test_method_desc = models.TextField(null=True, blank=True, help_text='测试方法描述')
    need_test_summary = models.BooleanField(default=False, help_text='是否需要测试总结')
    test_summary_desc = models.TextField(null=True, blank=True, help_text='测试总结描述')
    need_test_conclusion = models.BooleanField(default=False, help_text='是否需要测试结论')
    test_conclusion_desc = models.TextField(null=True, blank=True, help_text='测试结论描述')
    need_test_env = models.BooleanField(default=False, help_text='是否需要机器环境')
    test_env_desc = models.TextField(null=True, blank=True, help_text='机器环境描述')
    need_env_description = models.BooleanField(default=False, help_text='是否需要测试环境描述')
    env_description_desc = models.TextField(null=True, blank=True, help_text='测试环境描述')
...
class ReportTmplItemSuite(BaseModel):
    ...
    test_env_desc = models.TextField(null=True, blank=True, help_text='测试环境描述')
    need_test_description = models.BooleanField(default=False, help_text='是否需要测试说明')
    test_description_desc = models.TextField(null=True, blank=True, help_text='测试说明描述')
    need_test_conclusion = models.BooleanField(default=False, help_text='是否需要测试结论')
    test_conclusion_desc = models.TextField(null=True, blank=True, help_text='测试结论描述')
