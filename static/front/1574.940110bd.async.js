...
`])),function(g){var n=g.resize;return n?"col-resize":"default"}),N=function(n){var i=n.width,o=n.onResizeStart,u=n.onResize,h=n.onResizeStop,t=n.resize,r=(0,y.Z)(n,X);return(0,p.jsx)(M,(0,f.Z)((0,f.Z)({width:i||100,height:0,draggableOpts:{enableUserSelectHack:!1},onResizeStart:o,onResize:u,onResizeStop:h,resize:t?1:0},r),{},{children:(0,p.jsx)("th",(0,f.Z)({},r))}))},F=function(n){var i=n.columns,o=i===void 0?[]:i,u=n.name,h=n.onColumnsChange,t=(0,y.Z)(n,d),r=a.useState(0),te=(0,C.Z)(r,2),G=te[0],k=te[1],J=a.useState(0),q=(0,C.Z)(J,2),ee=q[0],U=q[1],ae=a.useState(!1),oe=(0,C.Z)(ae,2),K=oe[0],O=oe[1],_=a.useRef(null),S=(0,D.Z)(_),ie=function(R){return function(Y,ne){var H;if((0,T.Z)(ne),!!o[R].ellipsis){var ue=Y.clientX,le=ue-((H=_.current)===null||H===void 0?void 0:H.getBoundingClientRect().x);U(le),k(le),O(!0)}}},re=function(){return function(R){var Y,ne=R.clientX,H=ne-((Y=_.current)===null||Y===void 0?void 0:Y.getBoundingClientRect().x);k(H)}},se=function(R){return function(Y,ne){var H,ue=ne.size,le=Y.clientX,he=le-((H=_.current)===null||H===void 0?void 0:H.getBoundingClientRect().x),de=(0,B.Z)(o);if(de[R].ellipsis){var ce=ue.width+=he-ee,me=de[R],fe=me.dataIndex,ge=me.key;ce>20&&(de[R]=(0,f.Z)((0,f.Z)({},de[R]),{},{width:ce}),u&&I(u,fe||ge,ce),h==null||h())}k(0),U(0),O(!1)}},ve=a.useMemo(function(){return o.reduce(function(E,R){return R.width?E+=R==null?void 0:R.width:E},0)},[o]);return(0,p.jsxs)(Z,{ref:_,className:"resize-table-wrapper",children:[(0,p.jsx)(l.Z,(0,f.Z)((0,f.Z)({},t),{},{components:{header:{cell:N}},scroll:(n==null?void 0:n.scroll)||{x:ve||(S==null?void 0:S.width)},columns:o.filter(Boolean).map(function(E,R){return(0,f.Z)((0,f.Z)({},E),{},{onHeaderCell:function(ne){return{resize:!!E.ellipsis,width:ne.width,onResizeStart:ie(R),onResize:re(),onResizeStop:se(R)}}})})})),K&&(0,p.jsx)(z,{height:S==null?void 0:S.height,left:G||ee})]})},V=F,m=["name","columns","refreshDeps","onColumnsChange"],W="umi_locale",A=function(n,i){var o=localStorage.getItem(n),u=localStorage.getItem(W)||"zh-CN";if(!!o)return JSON.parse(o)["".concat(u,"-").concat(i)]},I=function(n,i,o){var u=localStorage.getItem(n),h=localStorage.getItem(W)||"zh-CN",t=(0,s.Z)({},"".concat(h,"-").concat(i),o);u?localStorage.setItem(n,JSON.stringify(Object.assign(JSON.parse(u),t))):localStorage.setItem(n,JSON.stringify(t))},Q=function(n){var i=n.name,o=n.columns,u=n.refreshDeps,h=u===void 0?[]:u,t=n.onColumnsChange,r=(0,y.Z)(n,m),te=a.useState([]),G=(0,C.Z)(te,2),k=G[0],J=G[1],q=function(){return(o==null?void 0:o.filter(Boolean).map(function(U){var ae=U.dataIndex,oe=U.key,K=U.width,O=ae||oe,_=A(i,O);!_&&K&&I(i,O,K);var S=_||K;return S&&(U.width=S),U}))||[]};return a.useEffect(function(){J(q())},h),(0,p.jsx)(V,(0,f.Z)({name:i,columns:k,setColumns:J,size:"small",onColumnsChange:function(){t==null||t(),J(q())}},r))}}}]);
