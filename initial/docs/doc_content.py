OVERVIEW_DOC = """<h3>T- One是什么</h3><p><span style="color: rgba(0, 0, 0, 0.85); font-size: 16px">T-One 是业内首个一站式、全场景质量协作平台；通过 T-One 能满足你的一切自动化测试需求：</span></p><ul><li><p><span style="color: rgba(0, 0, 0, 0.85); font-size: 16px">支持多CPU混合架构（x86、arm、loogarch、risc-v）</span></p></li><li><p><span style="color: rgba(0, 0, 0, 0.85); font-size: 16px">支持多操作系统类型（龙蜥OS、centos、debian、ubuntu、统信、麒麟）</span></p></li><li><p><span style="color: rgba(0, 0, 0, 0.85); font-size: 16px">支持复杂环境测试（企业内网、网络隔离环境、弹性云虚拟机/容器、应用集群及多种混合环境）</span></p></li></ul><p></p><h3>平台架构</h3><p><img src="https://intranetproxy.alipay.com/skylark/lark/0/2022/png/269913/1641453912404-27bd1c84-44b3-4777-99fa-b07e740a96be.png"></p><h3></h3><h3>核心特点</h3><ul><li><p>质量<strong>协作能力</strong>：</p></li></ul><ul><li><p>多企业、多团队之间的质量协作。</p></li><li><p>独立部署、分布式业务模型。</p></li><li><p>在线、离线测试能力。</p></li></ul><ul><li><p>全场景<strong>测试能力</strong>：</p></li></ul><ul><li><p>多 CPU 混合架构<span style="color: rgba(0, 0, 0, 0.85); font-size: 16px">（x86、arm、loogarch、risc-v）</span></p></li><li><p><span style="color: rgba(0, 0, 0, 0.85); font-size: 16px">支持多操作系统类型（龙蜥OS、centos、debian、ubuntu、统信、麒麟）</span></p></li><li><p><span style="color: rgba(0, 0, 0, 0.85); font-size: 16px">支持复杂环境测试（企业内网、网络隔离环境、弹性云虚拟机/容器、应用集群及多种混合环境）</span></p></li></ul><ul><li><p>全方位测试<strong>数据分析</strong>能力：</p></li></ul><ul><li><p>灵活的聚合型<strong>基线、指标跟踪</strong>模型。</p></li><li><p>时序分析、对比分析等<strong>数据分析</strong>能力。</p></li><li><p>自定义<strong>测试报告</strong>生成。</p></li></ul><ul><li><p>快速搭建开源软件包 <strong>CI 流程</strong>。</p></li><li><p>自动化<strong>缺陷定位诊断</strong>。</p></li><li><p>自定义<strong>测试计划</strong>。</p></li></ul><p></p><h3>应用场景</h3><p><strong>场景1：</strong>OS发布测试，每次AnolisOS的发布，社区测试团队会根据发布测试策略进行大规模测试，保障产品发布质量，外部用户可以在Testfarm查看发布测试数据。</p><p><strong>场景2：</strong>开源软件包CI，社区开发者可以将软件包注册到平台，平台会自动监控软件包的变更，一旦发生变更会立即进行测试并推送测试结果。</p><p><strong>场景3：</strong>自定义测试，社区开发者根据自己的需求可以在T-One平台进行在线测试，或者使用命令行测试。</p><p><strong>场景4：</strong>离线测试，对于网络不可达的测试环境，用户可以使用离线测试模式测试并上传数据。</p><p><strong>场景5：</strong>独立部署，外部用户也可以在自己环境下独立部署平台，测试并上传数据到Testfarm。</p><p><strong>场景6：</strong>登陆测试环境，社区开发者可以根据需要reserve测试环境登陆进行测试及debug。</p><p><strong>场景7：</strong>缺陷定位诊断，一旦测试出缺陷，平台会自动诊断缺陷引入的commit。</p><h3></h3><h3></h3>"""
